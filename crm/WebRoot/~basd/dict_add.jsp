...
<html:form action="basDictAction.do?method=doDictAdd">
...
<table class="query_form_table">
	...
	<tr>
		<th>条目</th>
		<td><html:text property="dictItem"></html:text><span class="red_star">*</span></td>
		<th>值</th>
		<td><html:text property="dictValue"></html:text><span class="red_star">*</span></td>
	</tr>	
	<tr>
		<th>是否可编辑</th>
		<td>
