...
<body>
<form action="cstServiceAction.do?method=selByService" method="post">
...
<table class="data_list_table">
	...
	<tr>
		...
		<td class="list_data_op">
			...
			<img onclick="to('cstServiceAction.do?method=FindByIdFeedBack&id=${v.svrId}');" title="处理" src="images/bt_feedback.gif" class="op_button" />  
