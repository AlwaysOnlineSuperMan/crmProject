...
<html:hidden property="atvId"  />
<html:hidden property="atvCustName"/>
...
<table class="query_form_table" id="table1">
	<tr>
		<th>时间</th>
				<td><html:text property="atvDate" readonly="true" ></html:text>
				<span class="red_star">*</span></td>
		<th>地点</th>
		<td>
				<html:text property="atvPlace" ></html:text>
	...
	<tr>
		<th>概要</th>
		<td>	
				<html:text property="atvTitle"  ></html:text>
				<span class="red_star">*</span></td>
		<th>备注</th>
		<td>
			<html:text property="atvTitle" ></html:text>
