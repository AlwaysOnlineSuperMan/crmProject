...
<html:form action="salChanceAction.do?method=doSalPlaneEdit">
<html:hidden property="chcUpdateDatetime"/>
<div class="button_bar">
	<button class="common_button" onclick="help('');">帮助</button>
	<button class="common_button" onclick="back();">返回</button>
	<button class="common_button" onclick="to('salChanceAction.do?method=doSalPlaneEdit');">保存</button>  
...
<table class="query_form_table">
	<tr>
		<th>编号</th>
		<td>
		<html:text property="chcId" readonly="true"></html:text>
		</td>
		<th>机会来源</th>
		<td>
