...
//var index2 = 'index2.jsp';
//var index3 = 'index3.jsp';
var smCallerWin;
var smNewMode;
var oldErrorHandler;
...
function initialise() {
	...
	L0101 = theMenu.addChild(L01, "Document", "销售机会管理", "salChanceAction.do?method=salChanceaManageList", "销售机会管理...");
	L0102 = theMenu.addChild(L01, "Document", "客户开发计划", "salPlanAction.do?method=planList", "客户开发计划...");

	
	L02 = theMenu.addChild(l2ID, "Folder", "客户管理", "", "客户管理...");
	L0201 = theMenu.addChild(L02, "Document", "客户信息管理", "cstCustomerAction.do?method=listAll", "客户信息管理...");
	...
	L0401 = theMenu.addChild(L04, "Document", "客户贡献分析", "ordersAction.do?method=nameOrprice", "客户贡献分析...");
