...
<html>
  ...
  <body>
		...
		<html:form action="sysRoleAction.do" method="post">
			<html:hidden property="method" value="doEditSysRole"/>
		...
		<button class="common_button" onclick="submit();">保存</button>
	   	...
	   	<table class="query_form_table">
	   		<tr>
	   			<th>编号</th>
	   			<td>
	   				<html:text property="roleId" readonly="true" size="20" ></html:text>	   				
	   			</td>
	   			<th>角色名</th>
	   			<td>
	   		...
	   		<tr>
	   			<th>角色描述</th>
	   			<td>
	   				<html:textarea property="roleDesc" cols="20" rows="3"></html:textarea>
	   			</td>
	   			<th>状态</th>
	   			<td>
