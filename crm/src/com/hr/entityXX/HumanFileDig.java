...
public class HumanFileDig implements java.io.Serializable {
	...
	/** full constructor */
	public HumanFileDig(ConfigMajor configMajor,
			ConfigFileThirdKind configFileThirdKind, String humanId,
			String firstKindId, String firstKindName, String secondKindId,
			String secondKindName, String thirdKindName, String humanName,
			String humanAddress, String humanPostcode,
			String humanProDesignation, String hunmaMajorName,
			String humanMajorKindId, String humanMajorKindName,
			String humanTelephone, String humanMobilephone, String humanBank,
			String humanAccount, String humanQq, String humanEmail,
			String humanHobby, String humanSpeciality, String humanSex,
			String humanReligion, String humanParty, String humanNationality,
			String humanRace, Timestamp humanBirthday, String humanBirthplace,
			Short humanAge, String humanEducatedDegree,
			Short humanEducatedYears, String humanEducatedMajor,
			String humanSocietySecurityId, String humanIdCard, String remark,
			String salaryStandardId, String salaryStandardName,
			Float salarySum, Float demandSalaraySum, Float paidSalarySum,
			...
			Timestamp recoveryTime, Boolean humanFileStatus, Date updateDateTime) {
	...
	public ConfigFileThirdKind getConfigFileThirdKind() {
		return this.configFileThirdKind;
	}
